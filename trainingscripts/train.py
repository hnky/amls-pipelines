...
parser.add_argument("--output-folder", type=str, dest="output_folder", help="data folder mounting point", default="C:\\Demos\\SimpsonsDemo\\")
...
print("input directory:{}".format(data_path))
...
def load_pictures(BGR):
    ...
    for k, char in map_characters.items():
        print("char",char)
        char_path = os.path.join(data_path,"%s/*" % char)
        print("char_path",char_path)
        pictures = [k for k in glob.glob(char_path)]
